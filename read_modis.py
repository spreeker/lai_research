...
def determine_xy(geotransform: list, projection: str, lon: float, lat: float):
...
def make_lonlat_bbox(dataset, verb=True):
...
def load_modis_data(filename, verb=True):
